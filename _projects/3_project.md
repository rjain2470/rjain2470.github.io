...
4. For further analysis, we can optionally convert our graph into a so-called knowledge graph, and, choosing an embedding model from the `PYKEEN` library, embed our graph into high-dimensional Euclidean space. This embedding will group nodes with high amounts of codependency close together, and vice versa.
